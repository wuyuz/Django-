    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.ManyToManyField(blank=True, related_name='roles', to='rbac.Permission', verbose_name='角色所拥有的权限')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('role', models.ManyToManyField(blank=True, related_name='users', to='rbac.Role', verbose_name='用户拥有角色')),
            ],
        ),
    ]
